...
You can install SingleFile on Firefox for Android Nightly by following this procedure:
...
- Chrome: https://developer.chrome.com/extensions/getstarted#manifest (omit the
  manifest creation)
- Microsoft Edge:
