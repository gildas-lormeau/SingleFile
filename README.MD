...
- Waterfox Classic
  - User interface elements displayed in the page (progress bar, logs panel, infobar) won't be displayed unless `dom.webcomponents.enabled` is enabled in `about:config`.
