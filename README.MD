...
- With auto-save active, the page will be automatically saved every time a new page is loaded.  The period of time to wait before saving the page can be configured in the options page.
