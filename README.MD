...
- Firefox:
  ...
  - Sometimes, SingleFile is unable to save the contents of  sandboxed iframes because of [this bug](https://bugzilla.mozilla.org/show_bug.cgi?id=1411641). This bug has been closed by Google as "WontFix".
- Waterfox
