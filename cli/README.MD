...
SingleFile can be launched from the command line by running it into a (headless) browser. It runs as a standalone script injected into the page to save instead of being embedded into a WebExtension.
