...
zip -r singlefile-extension-firefox.zip manifest.json common extension lib/single-file/dist _locales lib/single-file/processors/hooks/content/*-web.js
...
sed -i 's/207618107333-3pj2pmelhnl4sf3rpctghs9cean3q8nj/207618107333-7tjs1im1pighftpoepea2kvkubnfjj44/g' manifest.json
zip -r singlefile-extension-chromium.zip manifest.json common extension lib/single-file/dist _locales lib/single-file/processors/hooks/content/*-web.js
...
zip -r singlefile-extension-edge.zip manifest.json common extension lib/single-file/dist _locales lib/single-file/processors/hooks/content/*-web.js
rm -rf _locales/*
